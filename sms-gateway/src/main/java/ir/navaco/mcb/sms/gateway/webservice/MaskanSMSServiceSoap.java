...
public interface MaskanSMSServiceSoap {
     ...
     * @param serviceUser
     * @return
     *     returns javaapplication1.ArrayOfSTCSMSReceive3
     */
    ...
    @RequestWrapper(localName = "ExtendReceiveSMS", targetNamespace = "http://tempuri.org/", className = "javaapplication1.ExtendReceiveSMS")
    @ResponseWrapper(localName = "ExtendReceiveSMSResponse", targetNamespace = "http://tempuri.org/", className = "javaapplication1.ExtendReceiveSMSResponse")
    ...
    @RequestWrapper(localName = "GetRemainCredit", targetNamespace = "http://tempuri.org/", className = "javaapplication1.GetRemainCredit")
    @ResponseWrapper(localName = "GetRemainCreditResponse", targetNamespace = "http://tempuri.org/", className = "javaapplication1.GetRemainCreditResponse")
     ...
     * @param vIPAddress
     * @return
     *     returns javaapplication1.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "LikeSendSMS", targetNamespace = "http://tempuri.org/", className = "javaapplication1.LikeSendSMS")
    @ResponseWrapper(localName = "LikeSendSMSResponse", targetNamespace = "http://tempuri.org/", className = "javaapplication1.LikeSendSMSResponse")
    ...
    @RequestWrapper(localName = "SendSMS", targetNamespace = "http://tempuri.org/", className = "javaapplication1.SendSMS")
    @ResponseWrapper(localName = "SendSMSResponse", targetNamespace = "http://tempuri.org/", className = "javaapplication1.SendSMSResponse")
    ...
    @RequestWrapper(localName = "SendSMS_Single", targetNamespace = "http://tempuri.org/", className = "javaapplication1.SendSMSSingle")
    @ResponseWrapper(localName = "SendSMS_SingleResponse", targetNamespace = "http://tempuri.org/", className = "javaapplication1.SendSMSSingleResponse")
    ...
    @RequestWrapper(localName = "SingleStatusSMS", targetNamespace = "http://tempuri.org/", className = "javaapplication1.SingleStatusSMS")
    @ResponseWrapper(localName = "SingleStatusSMSResponse", targetNamespace = "http://tempuri.org/", className = "javaapplication1.SingleStatusSMSResponse")
     ...
     * @param batchId
     * @return
     *     returns javaapplication1.ArrayOfSTCSMSStatus
     */
    ...
    @RequestWrapper(localName = "StatusSMS", targetNamespace = "http://tempuri.org/", className = "javaapplication1.StatusSMS")
    @ResponseWrapper(localName = "StatusSMSResponse", targetNamespace = "http://tempuri.org/", className = "javaapplication1.StatusSMSResponse")
    ...
    @RequestWrapper(localName = "XSendSMS", targetNamespace = "http://tempuri.org/", className = "javaapplication1.XSendSMS")
    @ResponseWrapper(localName = "XSendSMSResponse", targetNamespace = "http://tempuri.org/", className = "javaapplication1.XSendSMSResponse")
    ...
    @RequestWrapper(localName = "XSendSMS2", targetNamespace = "http://tempuri.org/", className = "javaapplication1.XSendSMS2")
    @ResponseWrapper(localName = "XSendSMS2Response", targetNamespace = "http://tempuri.org/", className = "javaapplication1.XSendSMS2Response")
